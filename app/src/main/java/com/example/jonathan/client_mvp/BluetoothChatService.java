...
public class BluetoothChatService {
    ...
    public BluetoothChatService(Context context, Handler handler, Semaphore sem_connect, Semaphore sem_resp) {
        ...
        try {
            ...
            Log.v("BT: ", "sem for connect was interrupted");
        }
    ...
    public void write(byte[] out) {
        ...
        Log.d("BluetoothChatService", "BCS: sending msg of: " + out.toString());
        synchronized (this) {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Bluetooth_constants.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                ...
                try {
                    ...
                    // Blocks until something read
                    bytes = mmInStream.read(buffer); // will throw error when connection is cut, but we catch it and handle it.

                    ret_bMsg = buffer;
                    // Send the obtained bytes to the UI Activity
                    mHandler.obtainMessage(Bluetooth_constants.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                Log.v("BluetoothChatService", "BT: connected write operation");
                // Share the sent message back to the UI Activity
                mHandler.obtainMessage(Bluetooth_constants.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
